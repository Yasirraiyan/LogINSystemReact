...
export default function Home() {
  return (
    <div className="flex min-h-screen overflow-hidden">
      ...
      <div className="w-1/2 flex flex-col justify-center items-center bg-white px-16 mb-35">
      ...
      <div
        className="w-1/2 hidden md:flex relative items-start justify-start 
          ...
          rounded-3xl mt-7 mb-4 mr-7 h-[960px]"
      >
        <div className="items-start px-8 py-4 space-y-6 -translate-y-3 w-full">
          ...
          {/* Images */}
          <div className="flex gap-4 pl-5 mt-4 pt-20 w-full ">
            <Image
              src={img2}
              alt="Illustration 2"
              width={400}
            ...
            <Image
              ...
              height={337}
              className="rounded-lg  transition-transform duration-300 
                w-[170px] h-[337px] object-cover -translate-x-10 px-0"
            />
          </div>
        </div>
      </div>
