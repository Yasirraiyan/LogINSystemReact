...
export default function Home() {
  return (
    <div className="flex min-h-screen overflow-hidden">
      ...
      <div className="w-1/2 flex flex-col justify-center items-center bg-white px-16 mb-35 translate-y-20 overflow-hidden">
        <div
          className="w-full max-w-md width={461px}
          height={459px} gap={42px}"
        >
          <div className="mb-8">
          ...
          <form className="flex flex-col gap-6 mt-4 ml-2 scroll-position-fixed">
            <div className="flex flex-col">
              <label className="mb-1 text-gray-500">E-mail</label>
              <input
                type="email"
                placeholder="example@gmail.com"
                className="border border-gray-400 rounded-md px-4 py-[7px] pr-4.5 pl-4.5
                  focus:outline-none focus:ring-4 focus:ring-yellow-400 focus:bg-green-100 
                  transition-colors w-full width={460px} height={54px} radius={12px} border={1px} pt-[7px] pr-[18px] pb-[7px] pl-[18px] gap-[10px]"
              />
            </div>
            <div className="flex flex-col ">
              ...
              <div className="relative">
                <input
                  type="password"
                  placeholder="********"
                  className="border border-gray-400 rounded-md px-4 py-[7px] pr-4.5 pl-4.5 w-full
                    focus:outline-none focus:ring-4 focus:ring-yellow-400 focus:bg-green-100 width={460px} height={54px} radius={12px} border={1px} pt-[7px] pr-[18px] pb-[7px] pl-[18px] gap-[10px]"
                />
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <a
                href="#"
                className="text-yellow-500 hover:underline font-medium text-base leading-[150%] tracking-[0] font-[Mona_Sans]"
              >
                Forgot Password?
              </a>
            </div>
 ...
 */}
            <button
              ...
              className=" pt-[18px] pr-[186px] pl-[186px] pb-[18px] gap-[16px] font-semibold py-2 px-6 rounded-full hover:bg-yellow-500 active:bg-green-400 transition transform hover:scale-105 cursor-pointer width={460px} height={54px} position:fixed"
            >
              Sign in
            </button>
          </form>
          ...
          <div className="mt-20 mb-300 -translate-y-10 scroll-position-fixed">
            <div className="flex gap-4 pl-5 mt-12 pt-20 w-full mb-20 -translate-y-10">
              ...
              <Image
                ...
                height={337}
                className="rounded-lg  transition-transform duration-300 
                w-[399.61px] h-[337px] object-cover -translate-x-13"
              />
              <Image
                src={img3}
                alt="Illustration 3"
