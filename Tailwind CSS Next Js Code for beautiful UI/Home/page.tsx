...
export default function Home() {
  ...
  `}
      ...
      <div
        className=" w-1/2  hidden md:flex items-center justify-center bg-gradient-to-br from-yellow-400 to-yellow-100 mt-7 mb-4 mr-7 rounded-md width={947} height={960} rounded-4xl style={{
