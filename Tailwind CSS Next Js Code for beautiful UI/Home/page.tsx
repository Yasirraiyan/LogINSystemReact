...
export default function Home() {
  return (
    <div className="flex min-h-screen overflow-hidden shadow-3xl shadow-amber-200 from-top-left ">
          ...
          <form className="flex flex-col gap-6 mt-4 ml-2">
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`
       border border-gray-400 rounded-md px-4 py-2 pt-1.75 pb-1.75 pr-4.5 pl-4.5 w-full
    focus:outline-none focus:ring-4 focus:ring-yellow-400 focus:bg-green-100
    transition-colors width={460px} height={54px} radius={12px} border={1px} pt-[7px] pr-[18px] pb-[7px] pl-[18px] gap-[10px]
  `}
              />
            </div>
            <div className="flex flex-col">
              ...
              <div className="relative">
                <input
                  type="password"
                  placeholder="********"
                  className="border border-gray-400 rounded-md px-4 py-2 pt-1.75 pb-1.75 pr-4.5 pl-4.5 w-full focus:outline-none focus:ring-4 focus:ring-yellow-400  focus:bg-green-100 width={460px} height={54px} radius={12px} border={1px} pt-[7px] pr-[18px] pb-[7px] pl-[18px] gap-[10px]"
                />
            ...
            <button
              ...
              className=" pt-[18px] pr-[186px] pl-[186px] pb-[18px] gap-[16px] font-semibold py-2 px-6 rounded-full hover:bg-yellow-500 active:bg-green-400 transition transform hover:scale-105 cursor-pointer width={460px} height={54px}"
            >
              Sign in
            </button>
          </form>
      ...
      <div
        ...
        width={947} height={960} top={494.5} left={50.5} rounded-4xl style={{
       clipPath: 'polygon(0 0, 100% 0, 100% 85%, 0% 100%)',
       background: 'linear-gradient(to bottom right, from-[#F4CF16] to-[#FFF2B3]) '
     }}"
      >
