...
export default function Home() {
  return (
    <div className="flex min-h-screen overflow-hidden style={{ overflow: 'hidden'}}">
      ...
      <div className="w-1/2  flex flex-col justify-center items-center bg-white px-16 overflow-hidden">
        <div
          className="w-full max-w-md width={461}
          height={459}"
        >
          <div className="mb-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="relative">
                <input
                  type="password"
                  placeholder="********"
                  className="border border-gray-300 rounded-md px-4 py-2 pt-1.75 pb-1.75 pr-4.5 pl-4.5 w-full focus:outline-none focus:ring-4 focus:ring-yellow-400  focus:bg-green-100 width={460px} height={54px} radius={12px} border={1px} pt-[7px] pr-[18px] pb-[7px] pl-[18px] gap-[10px]"
                />
