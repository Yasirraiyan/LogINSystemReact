...
function page() {
  return (
    <div className="flex h-screen overflow-hidden shadow-3xl shadow-amber-900 from-top-left ">
      ...
      <div className="absolute top-0.5 left-5 z-50 px-35">
        {" "}
        <Image
      ...
      <div className="w-1/2 flex flex-col justify-center items-center bg-white px-16 overflow-hidden">
        <div className="w-full max-w-md width={461px} height={459px} top={298px} left={315px} gap={42px}">
          <div className="mb-8">
            <div>
            ...
            <form className="flex flex-col gap-6 mt-4 ml-2">
              ...
              <button
                ...
                className="pt-[18px] pr-[186px] pl-[186px] pb-[18px] gap-[16px] font-semibold py-2 px-6 rounded-[49px] width={460px} height={54px} "
              >
                Sign In
              </button>
            </form>
      ...
      <div
        className="w-1/2 hidden md:flex items-center justify-center bg-gradient-to-b from-yellow-400 via-yellow-300/30 to-yellow-100/0 mt-7 mb-4 mr-7 rounded-[20.03px] width={947} height={960} top={494.5} left={50.5}"
        style={{
          background:
            "linear-gradient(to bottom right, from-[#F4CF16] to-[#FFF2B3]) ",
        }}
      >
